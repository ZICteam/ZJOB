...
public class StatusBoardEntity extends Villager implements RoleBasedNpc {
    public StatusBoardEntity(EntityType<? extends Villager> entityType, Level level) {
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (player instanceof ServerPlayer serverPlayer) {
            ...
            sendStatusHint(serverPlayer, profile, useSecondary, targetJobId);
    ...
    private void sendStatusHint(ServerPlayer player, PlayerJobProfile profile, boolean secondary, String targetJobId) {
        final int radius = 16;
        ...
        player.sendSystemMessage(Component.translatable("message.advancedjobs.status_board.job_hint",
            ...
            progress.level(),
            progress.unlockedMilestones().size(),
            latestMilestone,
            latestTitle));
